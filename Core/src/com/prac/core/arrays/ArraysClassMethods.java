...
public class ArraysClassMethods {
	...
	/*	// TODO Auto-generated method stub
		int a[] = {10, 3, 2, 5, 8, 4, 3, 1, 1,1,1,1,2, 9, 7, 8};
		int a1[] = {10, 3, 2, 5, 8, 4, 3, 1, 1,1,1,1,2, 9, 7, 8};
		int a2[] = {10, 3, 2, 5, 8, 4, 3, 1, 1,2,1,2, 9, 7, 8};
	 ...
	 Stream.of(s).forEach(i->System.out.print(i+" "));		
		...
		Arrays.sort(s, //a the array to be sorted 
			...
			/*	Arrays.sort(s, 0, s.length, 
				Comparator.comparing(Integer::new, Comparator.reverseOrder()));*/
