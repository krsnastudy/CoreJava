...
public class ArrayListSorting {
	...
	public static void main(String[] args) {
		...
		List<Person> list = Arrays.asList(
			new Person("Anand", "Birla", 25, "Delhi"),
			new Person("Cath", "Demi", 21, "Bangalore"),
			new Person("Erek", "Huel", 15, "Bangalore"),
			new Person("Jakub", "Lisa", 36, "Hyderabad"),
			new Person("Morison", "Nurea", 12, "Hyderabad")
		);
...
//		list.stream().forEach(System.out::println);
		...
		System.out.println();
		printConditionally(list, p->p.getLastName().startsWith("L"), p->System.out.println("getLastName: "+p.getLastName()));
		
		System.out.println();
		printConditionally(list, p->p.getFirstName().startsWith("A"), p->System.out.println("getFirstName: "+p.getFirstName()));
