...
Predicate is a boolean valued function, contains test() It can always take Some 
Input values and perform some operations provided and returns boolean true or false

boolean test(T t) --> It evaluates this predicate on the given argument.

default Predicate<T> and(Predicate<? super T> other) --> 
It returns a composed predicate that represents a short-circuiting logical AND of this predicate and another. 
...
It returns a composed predicate that represents a short-circuiting logical OR of this predicate and another. 
