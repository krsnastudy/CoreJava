 ...
 * normally. The call System.exit(n) is effectively equivalent tothe call:
 * 
 * Runtime.getRuntime().exit(n)
 * 
 * Parameters:status exit status.Throws:SecurityException - if a security
 * manager exists and its checkExitmethod doesn't allow exit with the specified
 * status. See Also:java.lang.Runtime.exit(int)
 * 
 */