 ...
 * confusing but once you see the implementation, its really easy to grasp and
 * understand the minor difference between Factory and Abstract Factory pattern.
 * 
 * Abstract Factory Design Pattern Benefits: Abstract Factory design pattern
 * provides approach to code for interface rather than implementation. Abstract
 ...
 * and a factory LaptopFactory. Abstract Factory pattern is robust and avoid
