...
public class ClosestToZero {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        int result1 = getClosestToZero_JDK8(testingArray);
        System.out.println("The Closest Number To Zero in this Array is : " + result1);
    }
    ...
    public static int getClosestToZero_JDK8(int[] arr) {

        return Arrays.stream(arr)
                .boxed()
                .min((a, b) -> Integer.compare(Math.abs(a), Math.abs(b)))
                .get();
    }
}
