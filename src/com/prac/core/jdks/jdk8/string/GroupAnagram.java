...
//
        ...
        /***** JDK5 Logic Map *******/
        Map<String, List<String>> groupAnagrams_map = groupAnagrams_map(words2);
        System.out.println("\nGroup Anagrams JDK5 Maps\n" + groupAnagrams_map);


    }//main

    public static Map<String, List<String>> groupAnagrams_map(List<String> input) {
...
//            String key = new String(chars); // Sorted string as key
            map.computeIfAbsent(String.valueOf(chars), k -> new ArrayList<>()).add(word);
        }
